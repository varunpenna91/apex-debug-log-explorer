# Apex Debug Log Explorer v0.1.7
...
- Adds the new Apex Debug Log Explorer brand icon.
- Uses the icon in the desktop app header, upload screen, native macOS app bundle, Windows installer metadata, Linux app metadata, VS Code Marketplace listing, README, and release media.
- Removes the old unused Atlas-named concept asset.
- Publishes VS Code Marketplace cache-busted README image URLs for the branded version.
...
- Apple Silicon: `apex-debug-log-explorer-0.1.7-mac-arm64.dmg`
- Intel Mac: `apex-debug-log-explorer-0.1.7-mac-x64.dmg`
...
- `apex-debug-log-explorer-0.1.7-win-x64.exe`
...
- Download `apex-debug-log-explorer-0.1.7.vsix` from this release.
