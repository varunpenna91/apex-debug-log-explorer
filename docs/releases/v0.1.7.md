...
- Uses the icon in the desktop app header, upload screen, native macOS app bundle, Windows installer metadata, Linux app metadata, and VS Code Marketplace listing.
